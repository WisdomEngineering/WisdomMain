...
const basicIntroData = {
    'zh': {
        'head': '公司简介',
        'body': [
            '江苏智道工程技术有限公司是集研发、设计、核心制造、工程总承包、专业化运行维护为一体的国家高新技术企业。节能环保系统优化解决专家、DDS生物脱硫、膜等新技术工程应用领先者、远程智能优化运营维护行家。',
            '公司拥有国内外院士、专家组成的专家委员会，与美国肯塔基大学、北京大学、北京科技大学、东南大学、南京理工大学、南京工业大学、华东理工大学、南京师范大学等建立产学研合作关系。',
            '公司长期服务于中石化、中海油、中石油、巴斯夫、宝钢、武钢、南钢、马钢、荣钢集团、兵器集团等石化、冶金企业。',
            '科技净化环境，与客户共成功！'
        ]
    },
    'en': {
