...
const vocCases = [
    ...
    },
    {
        ...
        articleText: {
            zh: "本项目对机前作业区、硫铵作业区、机后作业区及油库区的逸散气进行治理，无组织排放点共计73个。逸散气内含有焦油、苯、萘、氨气、硫化氢和有机废气。根据现场槽罐实际情况及尾气排放特点和石油化工相关规范要求，对原有系统进行改造，能密闭的系统采用氮封调节压力、通过压力控制排放，收集后送煤气负压系统；对氧含量难以控制的系统，收集后的废气经多级吸收，脱除焦油、萘、苯、氨、硫化氢及重组分有机物后，送燃烧系统。收集系统增设阻火、氧含量分析及可燃气体浓度检测及伴热保温、合理的吹扫，确保改造后系统安全稳定，并符合超净排要求。装置规模2500m3/h,满足排放标准《挥发性有机物无组织排放控制标准》GB37822-2019的要求。",
    ...
    },
    {
        ...
        articleText: {
            zh: "本项目主要是对燃料供应厂化产区域（鼓冷、脱硫、硫铵、粗苯）无组织排放尾气进行治理，共计118个无组织排放点。焦化废气含焦油、苯、萘、氨气及硫化物及有机废气，进RTO之前必须对有害部分进行脱除。鼓冷区域采用“油洗+酸洗+碱洗”的预处理工艺技术；脱硫、硫铵及蒸氨区域采用“酸洗+碱洗”的预处理工艺技术；经预处理后的废气汇总后送RTO炉进行深度处理。根据尾气排放特点和石油化工相关规范要求，对原有系统进行改造，采用氮封调节压力、通过压力控制排放；收集系统增设阻火、氧含量分析及可燃气体浓度检测及伴热保温、合理的吹扫，确保改造后系统安全稳定，并符合超净排要求。装置规模25000m3/h,满足排放标准《挥发性有机物无组织排放控制标准》GB37822-2019的要求。",
