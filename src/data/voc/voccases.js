...
import VOCarticle8 from '../../images/projects/VOC/article8.jpg';
import VOCarticle9 from '../../images/projects/VOC/article9.jpg';
...
const vocCases = [
    ...
    },
    {
        ...
        articleText: {
            zh: "本项目对机前作业区、硫铵作业区、机后作业区及油库区的逸散气进行治理，无组织排放点共计73个。逸散气内含有焦油、苯、萘、氨气、硫化氢和有机废气。根据现场槽罐实际情况及尾气排放特点和石油化工相关规范要求，对原有系统进行改造，能密闭的系统采用氮封调节压力、通过压力控制排放，收集后送煤气负压系统；对氧含量难以控制的系统，收集后的废气经多级吸收，脱除焦油、萘、苯、氨、硫化氢及重组分有机物后，送燃烧系统。收集系统增设阻火、氧含量分析及可燃气体浓度检测及伴热保温、合理的吹扫，确保改造后系统安全稳定，并符合超净排要求。装置规模2500m³/h,满足排放标准《挥发性有机物无组织排放控制标准》GB37822-2019的要求。",
    ...
    },
    {
        ...
        articleText: {
            zh: "本项目主要是对燃料供应厂化产区域（鼓冷、脱硫、硫铵、粗苯）无组织排放尾气进行治理，共计118个无组织排放点。焦化废气含焦油、苯、萘、氨气及硫化物及有机废气，进RTO之前必须对有害部分进行脱除。鼓冷区域采用“油洗+酸洗+碱洗”的预处理工艺技术；脱硫、硫铵及蒸氨区域采用“酸洗+碱洗”的预处理工艺技术；经预处理后的废气汇总后送RTO炉进行深度处理。根据尾气排放特点和石油化工相关规范要求，对原有系统进行改造，采用氮封调节压力、通过压力控制排放；收集系统增设阻火、氧含量分析及可燃气体浓度检测及伴热保温、合理的吹扫，确保改造后系统安全稳定，并符合超净排要求。装置规模25000m³/h,满足排放标准《挥发性有机物无组织排放控制标准》GB37822-2019的要求。",
    ...
    },
    {
        ...
        articleText: {
            zh: "国内首创间接式冷凝+防爆型催化氧化燃烧处理；装置规模：间接冷凝：1400Nm³/h；洗涤：1000Nm³/h；催化氧化：3000Nm³/h；处理效果：采用具有自主知识产权的间接冷凝技术，首次应用于油气回收，运行稳定，无人值守；经济效益：比常规直冷节省能耗20%以上；回收油气MTBE产品年经济效益超过990万/a；社会效益：节省运保费用超过300万/a；减排有机污染物约1270t/a。",
            en: "国内首创间接式冷凝+防爆型催化氧化燃烧处理；装置规模：间接冷凝：1400Nm³/h；洗涤：1000Nm³/h；催化氧化：3000Nm³/h；处理效果：采用具有自主知识产权的间接冷凝技术，首次应用于油气回收，运行稳定，无人值守；经济效益：比常规直冷节省能耗20%以上；回收油气MTBE产品年经济效益超过990万/a；社会效益：节省运保费用超过300万/a；减排有机污染物约1270t/a。"
        },
        articleImage: VOCarticle8
    },
    {
        articleHead: {
            zh: "某石化公司全流程VOCs治理项目",
        ...
        articleText: {
            zh: "装置规模：10450Nm³/h；工艺技术：吸收、深冷、膜、吸附组合工艺及预处理组合工艺+RTO、RCO、CO后处理工艺送管道配风燃烧；处理效果：满足超低排放环保指标，达到A级企业环保绩效排放标准要求。回收效益：2877.4万元；社会效益：减排CO2 77t/a。",
            en: "装置规模：10450Nm³/h；工艺技术：吸收、深冷、膜、吸附组合工艺及预处理组合工艺+RTO、RCO、CO后处理工艺送管道配风燃烧；处理效果：满足超低排放环保指标，达到A级企业环保绩效排放标准要求。回收效益：2877.4万元；社会效益：减排CO2 77t/a。"
        },
        articleImage: VOCarticle9
    }
]
